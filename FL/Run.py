...
def parse_args():
    ...
    parser.add_argument('--communicator', help='Select communication protocol: TCP, UDP, ZMTP, AMQP, MQTT',
                        default='TCP')
    parser.add_argument('--model', help='Model type: VGG5 or VGG8', default='VGG8')
    parser.add_argument('--stress', help='Tool used to apply stress: CPU, NET, ALL', default=None)
    parser.add_argument('--limiter', help='Tool used to limit network: 3G, 4G, Wi-Fi', default=None)
    ...
    parser.add_argument('--target', help='Server IP', default='127.0.0.1')
